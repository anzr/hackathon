...
//	FOURSQUARE_OAUTH2("","","https://foursquare.com/oauth2/access_token", "https://foursquare.com/oauth2/authenticate",FoursquareQueryParameterAccessMethod.getInstance(),"","http://localhost","foursquare","https://api.foursquare.com/v2/users/self/checkins");
	VSO_OAUTH2("", "", "https://app.vssps.visualstudio.com/oauth2/token", "https://app.vssps.visualstudio.com/oauth2/authorize", BearerToken.authorizationHeaderAccessMethod(),"" ,"https://members.hack.com", "User", "");
	...
	public void setClientId(String cliId) {
		this.clientId = cliId;
	}

	public void setClientSecret(String cliSec) {
		this.clientSecret = cliSec;
	}
