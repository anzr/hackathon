...
public class OAuthAccessTokenActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		authorizationUrl = "https://app.vssps.visualstudio.com/oauth2/authorize?client_id=E87303F1-E66A-43D3-BA70-F48533FF6267&redirect_uri=https://members.hack.com/&response_type=Assertion&scope=vso.work_write";
	...
	private class ProcessToken extends AsyncTask<Uri, Void, Void> {
			...
			if (url.startsWith(Constants.OAUTH2PARAMS.getRederictUri())) {
        		...
        		try {
        			if (url.contains("code=")) {
						...
						//oAuth2Helper.requestAccessToken(authorizationCode);
            			startActivity=true;
			  		    hasLoggedIn=true;
		...
		protected void onPostExecute(Void result) {
			if (startActivity) {
				Log.i(Constants.TAG, " ++++++++++++ Going to Main Activity");
				Intent mainActivity=new Intent(OAuthAccessTokenActivity.this,MainActivity.class);
